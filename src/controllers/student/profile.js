...
export const editProfile = errorWrapper(async (req, res, next, session) => {
    ...
    if (shouldRegenerateRecommendation) {
        ...
        await req.user.save();
        await courseModel.populate(req.user, { path: "recommendations.data.course", select: "name discipline tuitionFee currency studyMode subDiscipline schoolName startDate studyLevel duration university elite featured startDate stemDetails" })
